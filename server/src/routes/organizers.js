...
router.post('/', protect, authorize('admin'), verifyAdminPassword, organizerController.create);
router.put('/:id', protect, authorize('admin'), verifyAdminPassword, organizerController.update);
