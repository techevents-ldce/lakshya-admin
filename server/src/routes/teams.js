...
router.delete('/:id/members/:userId', protect, authorize('admin'), verifyAdminPassword, teamController.removeMember);
router.patch('/:id/cancel', protect, authorize('admin'), verifyAdminPassword, teamController.cancelRegistration);
