...
const links = [
  ...
  { to: '/certificates', label: 'Certificates', icon: HiOutlineSparkles, superadminOnly: true },
  { to: '/certificates/validator', label: 'Cert Validator', icon: HiOutlineShieldCheck, superadminOnly: true },
